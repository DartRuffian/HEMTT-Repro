...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "hmt_fnc_recompile") then {hmt_recompiles = []; hmt_fnc_recompile = {{call _x} forEach hmt_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; hmt_recompiles pushBack _recomp;
#else
