        ...
        switch (_function) do {
            ...
            case "preview_run": {
                ...
                0 spawn {
                    ...
                    diag_log "Preview: Filter scope < 2 classes";
                    private _cfgVehicles = configFile >> "CfgVehicles";
                    ps_preview = ps_preview select { getNumber (_cfgVehicles >> _x >> "scope") == 2};

                    diag_log format ["Preview: %1", count ps_preview];
                    if (ps_preview isNotEqualTo []) then {
                        [1, "all", [], [], [], ps_preview] spawn BIS_fnc_exportEditorPreviews;
                    };
                    sleep 2;
